...
import Suggestions from "./RightpanelComponent/Suggestions";
      ...
      <div>
        ...
        <div className="mb-[20px]">
          <input
            ...
            className="w-full md:w-[450px] h-[54px] outline-none bg-white border-none text-[15px] text-black rounded-[15px] pl-[7px]"
          />
        </div>
        {search ? (
          searchResult.length ? (
